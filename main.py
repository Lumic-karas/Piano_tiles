...
# from пайгейм.test import background
...
class Tile(pg.sprite.Sprite):
    ...
    def press(self):
        ...
        # 1. она не была проиграна раньше
...
class Song:
    songs = []  # здесь будет храниться список всех доступных песен
...
text1 = f1.render('Предупреждение: возможны громкие звуки.', 1, (0, 0, 0))
